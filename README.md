...
# Dach (noun) [neuter]
- ### Pronunciation: /dax/ (dahkh)
- **Dach** (English 'roof') - A structure that covers the top of a building and provides protection from the elements.
- **Dach** (English 'roof') - A part of a vehicle that covers the interior space.
